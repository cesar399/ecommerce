                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="{{Storage::url('/' . 'Gallery'. ' /' .$product->image->shift()->url)}}" class="d-block w-100" alt="..." style="min-width: 515px; max-width: 516px; min-height: 479px; max-height: 480px;">
                        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="product-block">
                ...
                <div class="product-info panel">
                    ...
                    <p>
                        <a  class="btn btn-warning btn-block" href="{{route('cart-add', $product->id)}} "> Añadir <i class="fa fa-cart-plus fa-2x"></i></a>
                    </p>
                </div>
            </div>
        </div>
